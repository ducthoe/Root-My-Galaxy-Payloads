...
/*
 * SM-A566E / A566EXXSCCZG6
 *
 * Symbol/function offsets below are based on the boot image currently in:
 *   /home/eightydegrees/Pictures/root-my-galaxy-payloads/ida/boot-kernel.bin
 *
 * IDA database is intentionally kept at imagebase 0, so these are static
 * offsets from KIMAGE_TEXT_BASE. Runtime canonical address is:
 *   KIMAGE_TEXT_BASE + kaslr_slide + *_OFF
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "essi-A566EXXSCCZG6-app-physical-p0-safe-sweep"
...
#define SLIDE_PHYSICAL_SLOT_DELAYS_USEC \
  20000, 25000, 15000, 30000, 35000, 40000, 45000, 50000
...
/* IDA-verified A566EXXSCCZG6 offsets. */
