...
[Root My Galaxy](https://github.com/ducthoe/Root-My-Galaxy):
...
| `essi-A566EXXSCCZG6` | Galaxy A56 5G `SM-A566E` | `BP4A.251205.006.A566EXXSCCZG6` | `6.6.102-android15-8-abA566EXXSCCZG6-4k` | Exploit/root device-tested; KernelSU no-patch-text artifact pending hardware retest |
...
The SM-A566E CCZG6 analysis and late-load crash record is in
